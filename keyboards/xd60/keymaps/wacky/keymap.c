...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP(
      ...
      KC_NO,   KC_LGUI, KC_LALT,                             KC_SPC,                       KC_RALT, F(0),     KC_LEFT, KC_DOWN,  KC_RIGHT),
  ...
  KEYMAP(
      ...
      KC_LSFT, KC_NO,   KC_NO,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_VOLD, KC_VOLU, KC_MUTE,  KC_TRNS, KC_PGDN,  KC_TRNS,   \
      KC_TRNS, KC_TRNS, KC_TRNS,                          F(31),                                KC_TRNS, F(0),     KC_HOME, KC_PGUP,  KC_END),
